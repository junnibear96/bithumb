...
## "current_price_rank"를 "save_path" 경로에 'bithumb_trade_price_rank_오늘년월일_23'이라는 엑셀파일로 저장
current_price_rank.to_excel(save_path + 'bithumb_trade_price_rank_' + datetime.datetime.now().strftime('%Y%m%d') + '_23.xlsx', index=False)
print(save_path + 'bithumb_trade_price_rank_' + datetime.datetime.now().strftime('%Y%m%d') + '_23.xlsx 저장 완료')
# ==================================================
